...
async def generate_names(
    ...
    # Result count: clamp to [1, 1000]. Plans expose 20 / 200 / 500 / 1000.
...
async def check_only(
    ...
    # Cap matches the largest plan-driven batch (1000, Business). Anything beyond is
    ...
    domains = [d for d in domains if isinstance(d, str) and 3 <= len(d) <= 255][:1000]
    if not domains:
