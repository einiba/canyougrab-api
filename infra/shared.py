...
# VPC-internal services — use hostnames for blue-green compatibility
UNBOUND_IP = "10.108.0.5"  # legacy — use UNBOUND_HOSTNAME for new deploys
UNBOUND_HOSTNAME = "unbound.canyougrab.it"  # CF DNS → VPC private IP
